...
{
    class DataReaderConvertorGenerator<T>
    {
        internal string MethodBodyGenerator(SqlDataReader reader)
        {
            var statement = new StringBuilder();
            statement.AppendLine("public " + typeof(T).FullName + " Convert(SqlDataReader reader, object o)");
