...
namespace Shoniz.Common.Web.MVC
{
    public static class MvcExtention
    {
        ...
        /// <returns></returns>
        public static string CreatePartialView(this Controller controller, string partialViewName, object model)
        {
        ...
        public static object ToJsonObject(this PartialViewResult partial,Controller controller)
        {
            controller.ViewData.Model = partial.Model;
  
            using (var sw = new System.IO.StringWriter())
            {
                var viewResult = ViewEngines.Engines.FindPartialView(controller.ControllerContext, partial.ViewName);
                var viewContext = new ViewContext(controller.ControllerContext, viewResult.View, controller.ViewData,
                    controller.TempData, sw);
        ...
        public static object ToJsonObject(this string singleContent)
        {
            var newJson = new
                {
                    JsonMessage = singleContent
                };
